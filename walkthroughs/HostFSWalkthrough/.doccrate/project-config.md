...
|:---|:---|
| product_name | HostFS |
| product | HostFS | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | riscos-pi4 |
| source_file | riscos-pi4/hostfs |
...
| docheader_text | HostFS — the host file system as the boot path | Document cover banner title |
...
| header_text_left | HostFS | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | RISC OS on QEMU — riscos-pi4/hostfs | Optional text shown below the footer rule |
