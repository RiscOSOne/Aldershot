# Graphics and Sound walkthrough

## Variables

| Name | Value |
|:---|:---|
| product_name | Graphics and Sound |
| product | Graphics and Sound | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | riscos-pi4 |
...
| docheader_text | Graphics and sound — the blitter and the host displays | Document cover banner title |
...
| header_text_left | Graphics and Sound | Optional left header text |
