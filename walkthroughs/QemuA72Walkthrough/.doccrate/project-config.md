# QEMU A72 walkthrough

## Variables

| Name | Value |
|:---|:---|
| product_name | QEMU A72 |
| product | QEMU A72 | Product or documentation set name |
| mojo_version | 1.1.0 |
| repo_url | riscos-pi4 |
| source_file | RISCOSQEMUA72 |
...
| docheader_text | RISC OS on a Pi 4 in QEMU — the 32-bit A72 changes | Document cover banner title |
...
| header_text_left | QEMU A72 | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | RISC OS on QEMU — RISCOSQEMUA72 | Optional text shown below the footer rule |
