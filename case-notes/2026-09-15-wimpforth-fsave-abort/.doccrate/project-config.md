# WimpForth fsave abort -- case note

## Variables

| Name | Value |
|:---|:---|
| product_name | WimpForth fsave abort |
| product | WimpForth fsave abort | Product or documentation set name |
| repo_url | riscos-pi4 |
| source_file | case-notes/2026-09-15-wimpforth-fsave-abort |
...
| docheader_text | Case note — WimpForth fsave abort | Document cover banner title |
...
| header_text_left | Case notes | Optional left header text |
| header_text_right | {{MONTHYEAR}} | Optional right header text |
| footer | on | Set to on to draw a footer rule on exported pages |
| footer_text | RISC OS on QEMU — case notes | Optional text shown below the footer rule |
